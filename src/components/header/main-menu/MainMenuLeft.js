...
const MainMenuLeft = () => {
    ...
    const [isHoverLikeBtn, setIsHoverLikeBtn] = useState(false)
    const { user } = useContext(LoginContext)
    const { screenWidth, setIsLoginModalOpen, setIsBackdrop, setIsNewPostPage, setIsNewPostBtn } = useContext(Yad2Context)
    const history = useHistory()

    const onHoverLikeBtn = () => {
        setIsHoverLikeBtn(true)
    }

    const offHoverLikeBtn = () => {
        setIsHoverLikeBtn(false)
    }
            ...
            {screenWidth > 630 ?
                <ul>
                    {screenWidth > 960 && <li>
                        ...
                        {screenWidth > 1625 && <span>התראות</span>}
                    </li>}
                    <li onMouseEnter={onHoverLikeBtn} onMouseLeave={offHoverLikeBtn} >
                        ...
                        {screenWidth > 1625 && <span>מודעות שאהבתי</span>}
                        {
                            isHoverLikeBtn &&
                            <div className="dropdown liked">
                                <div id="liked-ads">
